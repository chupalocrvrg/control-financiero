      ...
      <div className="flex bg-neutral-200/50 dark:bg-neutral-800/50 p-1 w-fit rounded-2xl mx-auto md:mx-0 flex-wrap gap-1">
        <button
          ...
          className={cn(
            ...
            activeTab === 'USERS' ? "bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100 shadow-sm" : "text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-300"
          )}
        >
          Usuarios
        </button>
        ...
        <button
          ...
          className={cn(
            "px-6 py-2 rounded-xl text-sm font-bold transition-all",
            activeTab === 'HISTORY' ? "bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100 shadow-sm" : "text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-300"
          )}
        >
          Versiones
        </button>
        <button
          ...
          className={cn(
            "px-6 py-2 rounded-xl text-sm font-bold transition-all",
            activeTab === 'AUDIT' ? "bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100 shadow-sm" : "text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-300"
          )}
        >
          Auditoría
        </button>
        <button
          ...
          className={cn(
            "px-6 py-2 rounded-xl text-sm font-bold transition-all",
            activeTab === 'TRASH' ? "bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100 shadow-sm" : "text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-300"
          )}
        >
          Papelera
        </button>
            ...
            <table className="min-w-full divide-y divide-neutral-50 dark:divide-neutral-800">
              <thead className="bg-neutral-50 dark:bg-neutral-900 sticky top-0 z-10">
                <tr>
                  ...
                  <th className="px-8 py-4 text-right text-[10px] font-black text-neutral-400 uppercase tracking-widest">Control</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-neutral-50 dark:divide-neutral-800">
                {filteredUsers.map(u => (
                  ...
                  >
                    ...
                    <td className="px-8 py-6 text-right">
                      <div className="flex justify-end items-center gap-2">
                        ...
                        <button onClick={(e) => { e.stopPropagation(); viewUserData(u); }} className="p-3 bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400 rounded-2xl hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-500 transition-all">
