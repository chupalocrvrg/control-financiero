...
// 6. Update creation logic (and matched article add stock) - careful with replace
const oldCreationLogic = `        // Create new article
...
const creationLogic = `        // Create new article or update existing
        const batch = writeBatch(db);
        let artId = '';
...
content = content.replace(oldCreationLogic, creationLogic);
